...
in <<S_100,part=4a>>, which is a profile of the <<ISO_19115_1_2018>> Standard.
...
and details about the metadata classes are provided in <<sec_12.2;to!sec_12.5>>.
...
given in <<S_100,part=17>>. When this is done, the Remarks column contains
...
| Content defined in <<S_100,part=15>>. All certificates used, except
...
| fileName | Dataset file name | 1 | URI | See <<S_100,part=1,clause=1-4.6>>
...
| digitalSignatureReference | Specifies the algorithm used to compute digitalSignatureValue | 1 | S100_SE_DigitalSignatureReference (see <<S_100,part=15>>) |

| digitalSignatureValue | Value derived from the digital signature | 1..*
| S100_SE_DigitalSignature +
(see <<S_100,part=15>>)
| The value resulting from application of digitalSignatureReference Implemented as the digital signature format specified in <<S_100,part=15>>
...
| producingAgency | Agency responsible for producing the data | 1 | CI_Responsibility>CI_Organisation | See <<S_100,part=17,table=17-3>>
...
later in this PartFormat: PnYnMnDTnHnMnS (XML built in type for <<ISO_8601>> duration). See <<S_100,clause=17-4.9>>
...
| Value       | ISO/IEC 8211    | The ISO/IEC 8211 data format as defined in <<S_100,part=10a>>  | 1 | -
| Value       | GML             | The GML data format as defined in <<S_100,part=10b>>           | 2 | -
| Value       | HDF5            | The HDF5 data format as defined in <<S_100,part=10c>>          | 3 | -
...
| 0..1 | S100_CompliancyCategory | See <<S_100,part=4a,clause=4a-5.5>>
...
| Value       | S100p15               | IHO S-100 Part 15       | 1 | See <<S_100,part=15>>
...
| fileName | Name of the support file | 1 | URI | See <<S_100,part=1,clause=1-4.6>>
...
| digitalSignatureReference | Specifies the algorithm used to compute digitalSignatureValue | 1 | S100_SE_DigitalSignatureReference (see <<S_100,part=15>>) | Reference to the appropriate digital signature algorithm
| digitalSignatureValue | Value derived from the digital signature | 1..* | S100_DigitalSignature (see <<S_100,part=15>>) | The value resulting from application of digitalSignatureReferenceImplemented as the digital signature format specified in <<S_100,part=15>>
