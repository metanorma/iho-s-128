...
packages use the spatial types from <<S_100,part=7>>, which are imported
...
roles, and multiplicities apply. These conventions are described
in <<S_100,part=1>>.
...
<<S_100,part=10b>> provides further details about encoding in GML datasets
...
configuration level 3a (<<S_100,part=7>>). S-128 further constrains Level
